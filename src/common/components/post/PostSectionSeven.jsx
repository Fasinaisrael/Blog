              ...
              <Nav className="axil-tab-button nav nav-tabs mt--20">
                {filters.map((data) => (
                  <Nav.Item key={data.id}>
                    <Nav.Link onClick={""} eventKey={data.cate}>
                      {data.cate}
                    </Nav.Link>
                  </Nav.Item>
                ))}
                    ...
                    <div className="col-xl-7 col-lg-7 col-md-12 col-12">
                      <div className="active show content-block post-grid post-grid-large mt--30">
                        {fuzionFirstPost.featureImg ? (
                          <div className="post-thumbnail">
                            {/* <Link href={`/post/${fuzionFirstPost.slug}`}> */}
                            <Link href={"/post/#"}>
                              <a>
                                <Image
                              ...
                              <div className="post-meta">
                                ...
                                <div className="content">
                                  <h6 className="post-author-name">
                                    <Link
                                      href={`/author/${fuzionFirstPost.author_name}`}
                                    >
                                      <a className="hover-flip-item-wrapper">
                                        <span className="hover-flip-item">
                                          <span
                                  ...
                                  <ul className="post-meta-list">
                                    <li>{fuzionFirstPost.date}</li>
                                    <li>{fuzionFirstPost.post_views}</li>
                                  </ul>
                                </div>
                              </div>
                              <ul className="social-share-transparent justify-content-end">
                                {/* {fuzionFirstPost.author_social.map((data) => (
                                  <li key={data.url}>
                                    <a href={data.url}>
